...
class ClDrawer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Drawer(
      width: isDrawerExpanded ? 250 : 75, // Adjust the width of the drawer,
      child: AnimatedContainer(
        duration: const Duration(milliseconds: 200),
        //isDrawerExpanded ? 250 : 70, // Adjust the width of the drawer
        child: Column(
          children: <Widget>[
            DrawerHeader(
                ...
                children: [
                  ...
                  _createDrawerItem(
                      ...
                      onTap: () => ref
                          ...
                          .state = 'Report',
                      isSelected:
                          ref.watch(selectedSectionProvider) == 'Report',
                      isTextVisible: isDrawerExpanded),
                  _createDrawerItem(
                  ...
                  _createDrawerItem(
                      ...
                      onTap: () => ref
                          ...
                          .state = 'Orders',
                      isSelected:
                          ref.watch(selectedSectionProvider) == 'Orders',
                      isTextVisible: isDrawerExpanded),
                  _createDrawerItem(
